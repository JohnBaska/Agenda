...
from Projeto.Relatorio import *

class Agenda(Relatorio):
    #Função principal
    def __init__ (self):
        self.janela = Tk()
        self.tela()
    ...
    def informacoes (self):
        ...
        self.Estado_entry = OptionMenu(self.Cadastro, self.estado, "AL", "AP", "AM", "BA", "CE", "DF", "ES", "GO", "MA", "MT", "MS", "MG","PA", "PB", "PR", "PE", "PI", "RJ", "RN", "RS", "RO", "RR", "SC", "SP", "SE", "TO")
        ...
        self.Estado_entry = OptionMenu(self.Alteração, self.estado, "AL", "AP", "AM", "BA", "CE", "DF", "ES", "GO", "MA", "MT", "MS", "MG","PA", "PB", "PR", "PE", "PI", "RJ", "RN", "RS", "RO", "RR", "SC", "SP", "SE", "TO")
        self.Estado_entry.place(relx=0.05, rely=0.61, relwidth=0.1, relheight=0.08)
        ...
        self.Estado_entry = OptionMenu(self.Busca, self.estado, "AL", "AP", "AM", "BA", "CE", "DF", "ES", "GO", "MA", "MT", "MS", "MG","PA", "PB", "PR", "PE", "PI", "RJ", "RN", "RS", "RO", "RR", "SC", "SP", "SE", "TO")
        self.Estado_entry.place(relx=0.05, rely=0.61, relwidth=0.1, relheight=0.08)
        ...
        self.Estado_entry = OptionMenu(self.Exclusão, self.estado, "AL", "AP", "AM", "BA", "CE", "DF", "ES", "GO", "MA", "MT", "MS", "MG","PA", "PB", "PR", "PE", "PI", "RJ", "RN", "RS", "RO", "RR", "SC", "SP", "SE", "TO")
        self.Estado_entry.place(relx=0.05, rely=0.61, relwidth=0.1, relheight=0.08)

        #cidade
        Label(self.Cadastro, text="Cidade: ", bg="DodgerBlue", fg="indigo").place(relx=0.18, rely=0.53)
        self.Cidade_entry = Entry(self.Cadastro, bg='#dfe3ee', fg='#107bd2', font=("Verdana", 13))
        ...
        self.Cidade1_entry = Entry(self.Alteração, bg='#dfe3ee', fg='#107bd2', font=("Verdana", 13))
        ...
        self.Cidade2_entry = Entry(self.Busca, bg='#dfe3ee', fg='#107bd2', font=("Verdana", 13))
        ...
        self.Cidade3_entry = Entry(self.Exclusão, bg='#dfe3ee', fg='#107bd2', font=("Verdana", 13))
